<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="DeliverOrder.aspx.cs" Inherits="Team11AD.DeliverOrder" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="body" runat="server">
    <div class="panel-body">
        ...
        <div class="row">
            <div class="col-lg-9">
                <div class="form-group">
                    <asp:GridView ID="GridView1" runat="server" CssClass="table table-responsive" AutoGenerateColumns="False" GridLines="None">
                        <Columns>
