<%@ Page Title="" Language="C#" MasterPageFile="~/DUser.Master" AutoEventWireup="true" CodeBehind="ViewRequisitionList.aspx.cs" Inherits="Team11AD.ViewRequisition" %>
	    ...
	    <div class="row">
            <div class="col-lg-12">
                <div class="form-group">
                    <asp:HyperLink ID="HyperLink1" NavigateUrl="RequestRequisition.aspx" CssClass="btn btn-primary" runat="server">Add New Requisition</asp:HyperLink>
                </div>
